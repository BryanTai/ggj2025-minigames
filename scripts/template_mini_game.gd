...
# 	"_on_end_XXX_state"
# 	"_process_XXX_state"
## You need to add your game logic into these functions (found at the bottom of this file)
# You can also use the original _process function for any logic that doesn't care about the current state of the minigame
...
func _ready() -> void:
	...
	# this is the equivalent of "_on_start_preparing_state"
...
# See _ready() for any _on_start_preparing_state logic
...
func _process_playing_state(delta: float) -> void:
	## TODO: Most of your game logic will go here!
